...
def train_dino(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(student, teacher, teacher_without_ddp, dino_loss,recons_loss,
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss,recons_loss, data_loader,
